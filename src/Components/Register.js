			   ...
			   <div className="section">
                   ...
                   <div className="row">
                       ...
                       <div className="col-md-8">
                           <p className="boldText">Join Kawolegal. Signup to get your Startups listed now</p>
                       </div>
                       <div className="col-md-2"></div>
                   </div>
                   <br/>
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-8">
                            <form>
                                ...
                                <input type="email" className="form-control" id="exampleInputEmail1" placeholder="Confirm Password"/>
                                </div>
	...
	<footer className="container-fluid footer">
		<div className="row">
		  <div className="col-md-6">
			<p className="text-color text-center">©2017 kawolegal. All Rights Reserve</p>
		  </div>
